    ...
    config = function()
      ...
      gs.setup({
        on_attach = function(bufNum)
          ...
          vim.keymap.set('n', '<leader>gu', gs.undo_stage_hunk, { desc = "Reset Staged Hunk", buffer = bufNum })
          vim.keymap.set('n', '<leader>gR', gs.reset_buffer, { desc = "Reset Staged Buffer", buffer = bufNum })
          vim.keymap.set('n', '<leader>gk', gs.preview_hunk, { desc = "Preview Hunk", buffer = bufNum })
          vim.keymap.set('n', '<leader>gb', gs.toggle_current_line_blame, { desc = "Toggle line blame", buffer = bufNum })
